...
QUALTRICS_STIME <- ymd_hms("2025-12-01 00:00:01")
QUALTRICS_ETIME <- ymd_hms("2026-02-01 23:59:00")
...
For more information and steps on how to start creating a survey in Qualtrics, how to process and clean the data to remove confidential data, see this [presentation](https://labordynamicsinstitute.github.io/tutorial-preserving-survey/presentation/).
