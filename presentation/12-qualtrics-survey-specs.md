...
(two notes here about downloading Qualtrics survey definitions `qsf` - manually )
(also use get the Word version (cleaner layout) and the PDF version (for archiving))
